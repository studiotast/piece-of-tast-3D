...
export default class Environment {
  ...
  setSunLight() {
    ...
    this.sunLight.position.set(-0.5, 3, -2.5);
  ...
  setOfficeEnvMap() {
    this.environmentMap.texture = this.resources.items.hdrEnvironmentMapOffice;
  ...
  setStreetEnvMap() {
    this.environmentMap.texture = this.resources.items.hdrEnvironmentMapStreet;
  ...
  setDiscoEnvMap() {
    this.environmentMap.texture = this.resources.items.hdrEnvironmentMapDisco;
  ...
  setNormalEnvMap() {
    this.environmentMap.texture = this.resources.items.hdrEnvironmentMapNormal;
